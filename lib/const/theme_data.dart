...
class OneThemeData with Diagnosticable {
  ...
  factory OneThemeData.fromContext(BuildContext context) {
    ...
    theme.s10w4SteelGrey = theme.body2.copyWith(fontSize: 10, color: OneColors.steelGrey);
    ...
    theme.s12w4SteelGreyItalic = theme.body2.copyWith(fontStyle: FontStyle.italic, color: OneColors.steelGrey, fontSize: 12);

    /// fontSize: 12.0; fontWeight: 400; color: greyBlur
    theme.s12w4GreyBlur = theme.s12w4GreyDark.copyWith(color: OneColors.greyBlur);

    /// fontSize: 12.0; fontWeight: 400; color: white ; height: 1.3
    theme.s12w4White = theme.body2.copyWith(fontSize: 12, color: OneColors.white, height: 1.3);

    /// fontSize: 12.0; fontWeight: 400; color: steelGrey ;
    theme.s12w4SteelGrey = theme.body2.copyWith(fontSize: 12, color: OneColors.steelGrey);

    /// fontSize: 12.0; fontWeight: 600; color: textGrey2;
    theme.s12w6TextGrey2 = theme.body2.copyWith(color: OneColors.textGrey2, fontWeight: FontWeight.w600, fontSize: 12);

    /// fontSize: 12.0; fontWeight: 700; color: textGreyDark
    theme.s12w7TextGreyDark = theme.title1.copyWith(fontSize: 12.0);

    /// fontSize: 14.0; fontWeight: 400; color: OneColors.greyBlur
    theme.s14w4GreyBlur = theme.title2.copyWith(color: OneColors.greyBlur, fontSize: 14);

    /// fontSize: 14.0; fontWeight: 400; color: OneColors.greyBlur, height: 1.5;
    theme.s14w4GreyBlurHeight = theme.title2.copyWith(color: OneColors.greyBlur, fontSize: 14, height: 1.5);

    /// fontSize: 14.0; fontWeight: 400; color: OneColors.textGrey1; (same as theme.body2)
    theme.s14w4TextGrey1 = theme.body2.copyWith(color: OneColors.textGrey1);

    /// fontSize: 14.0; fontWeight: 400; color: OneColors.steelGrey; (same as theme.body2)
    theme.s14w4SteelGrey = theme.body2.copyWith(color: OneColors.steelGrey);

    /// fontSize: 14.0; fontWeight: 400; color: OneColors.error; (same as theme.body2)
    theme.s14w4Error = theme.body2.copyWith(color: OneColors.error);

    /// fontSize: 14.0; fontWeight: 400; color: OneColors.success; (same as theme.body2)
    theme.s14w4Success = theme.body2.copyWith(color: OneColors.success);

    /// fontSize: 14.0; fontWeight: 400; color: OneColors.textGuide; height: 1.5
    theme.s14w4TextGuideHeight = theme.body2.copyWith(color: OneColors.textGuide, height: 1.5);

    /// fontSize: 14.0; fontWeight: 400; color: OneColors.steelGrey; height: 1.5
    theme.s14w4SteelGreyHeight = theme.body2.copyWith(color: OneColors.steelGrey, height: 1.5);

    /// fontSize: 14.0; fontWeight: 400; color: OneColors.white
    theme.s14w4White = theme.body2.copyWith(color: OneColors.white);

    /// fontSize: 14.0; fontWeight: 500; color: OneColors.brandVNPT
    theme.s14w5BrandVNPT = theme.title1.copyWith(color: OneColors.brandVNPT, fontSize: 14, fontWeight: FontWeight.w500);

    /// fontSize: 14.0; fontWeight: 500; color: OneColors.greyBlur
    theme.s14w5GreyBlur = theme.title1.copyWith(color: OneColors.greyBlur, fontSize: 14, fontWeight: FontWeight.w500);

    /// fontSize: 14.0; fontWeight: 500; color: OneColors.steelGrey; (same as theme.s14w5BrandVNPT)
    theme.s14w5SteelGrey = theme.s14w5BrandVNPT.copyWith(color: OneColors.steelGrey);

    /// fontSize: 14.0; fontWeight: 600; color: OneColors.greyBlur
    theme.s14W6GreyBlur = theme.s14w5GreyBlur.copyWith(fontWeight: FontWeight.w600);

    /// fontSize: 14.0; fontWeight: 500; color: OneColors.primary; (same as theme.body1)
    theme.s14w5Primary = theme.body1.copyWith(fontWeight: FontWeight.w500, color: OneColors.primary);
    ...
    theme.s14w5BlackHeight = theme.body1.copyWith(color: Colors.black, height: 1.5, fontWeight: FontWeight.w500);

    /// fontSize: 14.0; fontWeight: 600; color: OneColors.actionBackAppbar
    theme.s14W6GreyBlur = theme.s14w5GreyBlur.copyWith(fontWeight: FontWeight.w600);

    /// fontSize: 14.0; fontWeight: 600; color: OneColors.primary; (same as theme.body1)
    theme.s14w6Primary = theme.body1.copyWith(fontWeight: FontWeight.w600, color: OneColors.primary);

    /// fontSize: 14.0; fontWeight: 600; color: textGrey2
    theme.s14w6TextGrey2 = theme.body2.copyWith(color: OneColors.textGrey2, fontWeight: FontWeight.w600);
    ...
    theme.s14w6SteelGrey = theme.s14w6TextGreyDark.copyWith(color: OneColors.steelGrey);

    /// fontSize: 14.0; fontWeight: w600; color: OneColors.greyBlur; (same as theme.s14w4GreyBlur)
    theme.s14w6GreyBlur = theme.s14w4GreyBlur.copyWith(fontWeight: FontWeight.w600);
    ...
    /// fontSize: 15.0; fontWeight: 500; color: OneColors.white; (same as theme.s14w5Primary)
    theme.s15w5White = theme.s14w5Primary.copyWith(fontSize: 15, color: OneColors.white);

    /// fontSize: 15.0; fontWeight: 500; color: OneColors.primary; (same as theme.s14w5BrandVNPT)
    theme.s15w5Primary = theme.s14w5BrandVNPT.copyWith(color: OneColors.primary, fontSize: 15);

    /// fontSize: 15.0; fontWeight: w600; color: OneColors.primary;
    theme.s15w6Primary = theme.s15w5Primary.copyWith(fontWeight: FontWeight.w600);

    /// fontSize: 15.0; fontWeight: w600; color: OneColors.greyBlur;
    theme.s15w6GreyBlur = theme.s14w6GreyBlur.copyWith(fontWeight: FontWeight.w600);

    /// fontSize: 16.0; fontWeight: 500; color: OneColors.white; (same as theme.title1)
    theme.s16w5White = theme.title1.copyWith(color: OneColors.white, fontWeight: FontWeight.w500);

    /// fontSize: 16.0; fontWeight: 600; color: OneColors.primary
    theme.s16w6Primary = theme.title1.copyWith(fontWeight: FontWeight.w600, color: OneColors.primary);

    /// fontSize: 16.0; fontWeight: 600; color: OneColors.greyBlur
    theme.s16w6GreyBlur = theme.title1.copyWith(fontWeight: FontWeight.w600, color: OneColors.greyBlur);

    /// fontSize: 16.0; fontWeight: 600; color: OneColors.redLight; (same as theme.s16w6Primary)
    theme.s16w6RedLight = theme.s16w6Primary.copyWith(color: OneColors.redLight);

    /// fontSize: 16.0; fontWeight: 700; color: OneColors.textGreyDark
    theme.s16w7TextGreyDark = theme.title1.copyWith(color: OneColors.textGreyDark);

    /// fontSize: 17.0; fontWeight: 400; color: Colors.black; (same as theme.title1)
    theme.s17w4GreyBlur = theme.title1.copyWith(color: OneColors.greyBlur, fontSize: 17, fontWeight: FontWeight.w400);

    /// fontSize: 17.0; fontWeight: 600; color: Colors.black; (same as theme.title1)
    theme.s17w6Black = theme.title1.copyWith(color: Colors.black, fontSize: 17, fontWeight: FontWeight.w600);

    /// fontSize: 23.0; fontWeight: 600; color: greyBlur
    theme.s23w6GreyBlur = theme.body1.copyWith(fontSize: 23, fontWeight: FontWeight.w600, color: OneColors.greyBlur);
    ...
    theme.s16w4GreyBlur = theme.body1.copyWith(fontSize: 16, fontWeight: FontWeight.w400, color: OneColors.greyBlur);
    ...
    theme.textFieldLabelFocused = theme.textFieldLabel.copyWith(color: OneColors.brandVNPT, fontSize: 16);
    theme.textFieldText = theme.textFieldLabel.copyWith(fontSize: 14.0, color: OneColors.textGreyDark, fontWeight: FontWeight.w400);
    theme.textFieldTextDisabled = theme.textFieldText.copyWith(color: OneColors.textGrey1, fontWeight: FontWeight.w400);
